// APB-controlled 6-digit 7-segment display — MUTATION C: Decoder fault.
// Digit 4'h5 segment pattern is corrupted to inject a detectable decoder error.
    ...
    function [6:0] hex_to_seg;
        ...
        begin
            case (value)
                ...
                // MUTATION C: digit 5 pattern corrupted (was 7'b0010010, now inverted)
