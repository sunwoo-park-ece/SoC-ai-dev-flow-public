// APB-controlled 6-digit 7-segment display — MUTATION B: RAW field mapping fault.
// HEX0 and HEX1 raw field assignments are swapped to inject a detectable mapping error.
// This file is an ISOLATED COPY for S4 fault-injection testing only.
// DO NOT use in production or merge to main.
module APB_HEX_display (
    ...
    localparam [15:0] REG_VALUE    = 16'h0000;
    localparam [15:0] REG_CTRL     = 16'h0004;
    localparam [15:0] REG_RAW_LOW  = 16'h0008;
    localparam [15:0] REG_RAW_HIGH = 16'h000c;
    ...
    // MUTATION B: HEX0 and HEX1 raw field swapped (raw_low_reg[13:7] → HEX0, [6:0] → HEX1)
    wire [6:0] out_hex0 = raw_mode ? raw_low_reg[13:7]   : dec_hex0;  // MUTATED: was [6:0]
    wire [6:0] out_hex1 = raw_mode ? raw_low_reg[6:0]    : dec_hex1;  // MUTATED: was [13:7]
