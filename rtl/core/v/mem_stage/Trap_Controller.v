...
module TrapController #(
    ...
    input wire [3:0] trap_status,      // includes bus access-fault codes
        ...
        default: begin
            case (trap_handle_state)
                ...
                WRITE_MEPC: begin 
                    ...
                    else if (trap_status == `TRAP_LOAD_ACCESS_FAULT) csr_trap_write_data = 32'd5;
                    else if (trap_status == `TRAP_STORE_ACCESS_FAULT) csr_trap_write_data = 32'd7;
